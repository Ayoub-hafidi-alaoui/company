  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <div class="header-social-links">
        ...
        <a href="#" class="<?= $socialMedia["name"] ?>"><i class="<?= $socialMedia["icon"] ?>"></i></a>
        <?php } ?>
      </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
          ...
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
                ...
                <?php foreach ($portfolios as $portfolio) { ?>
                    <li data-filter=".filter-<?= $portfolio["name"]; ?>"><?= $portfolio["name"] ?></li>
                <?php } ?>
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $project["portfolio_name"] ?>">
            <img src="<?= $project["img"] ?>" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4><?php echo $project['project_name']; ?></h4>
              <p><?=$project["portfolio_name"] ?></p>
              <a href="<?= $project["img"] ?>" data-gall="portfolioGallery" class="venobox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
        ...
        <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-4 col-6">
            <div class="client-logo">
              <img src="<?= $client["img"] ?>" class="img-fluid" alt="">
            </div>
          </div>
            <?php } ?>
